...
export default function PoolHomeClient({
  initialSnapshot
}: {
  initialSnapshot: PoolSnapshot;
}) {
        ...
        <div className="statusPanel" aria-live="polite">
          ...
          <dl>
            ...
            <div>
              ...
              <dd>
                {displayStat(
                  `${formatTxm(snapshot.stats.total_pending_net_atoms)} TXM`
                )}
              </dd>
            </div>
            <div>
      ...
      <section id="miner" className="splitSection">
        ...
        <form className="lookupPanel" onSubmit={submitLookup} aria-busy={isPending}>
          ...
          <div className="lookupHint">
            ...
            <span>
              {isPending
                ? "Opening miner dashboard..."
                : "Search opens the address dashboard."}
            </span>
          </div>
        ...
        <div className="sectionHeader">
          <div>
            ...
            <p className="sectionNote">
              This table shows <strong>pool ledger</strong> entries only. Direct
              or solo-mined blocks settle on-chain to the miner wallet and do not
              appear in pool payout accounting.
            </p>
          </div>
          <History size={24} />
        </div>
      ...
      <table>
        ...
        <tbody>
          {rows.map((row) => {
            ...
            const rejPct =
              total > 0
                ? ((row.rejected_shares / total) * 100).toFixed(1)
                : "0.0";
